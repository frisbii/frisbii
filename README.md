hello! i'm **madi**, an undergraduate student studying computer science at amherst college (go mammoths! 🦣)

notable projects:
* [*CGC*](https://github.com/jesselooney/cgc) is a research tool that implements polymorphic garbage collection for C. Developed for an independent study at Amherst College. Key technologies: **C**, **Python**.
* [*A-normalized call-by-push-value*](https://github.com/yiyunliu/cbpv-anf) is a language that combines the explicit sequencing and optimizations of A-normalized form and the adaptability of call-by-push-value. Contributed to during a research internship at the University of Pennsylvania. Key technologies: **Rocq**, *formal methods*
...
![Amherst College web button](https://mgudin27.people.amherst.edu/assets/button.webp)
